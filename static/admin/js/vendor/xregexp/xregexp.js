 ...
 * is in fact a native `RegExp` and a_works with all native methods.
 * @class XRegExp
 * @constructor
...
/**
 * Returns `true` if an object is a regex; `false` if it isn't. This a_works correctly for regexes
